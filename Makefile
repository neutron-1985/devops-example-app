...
# docker run --platform linux/amd64 -p 3000:3000 -e SERVER_MESSAGE="Hexlet Awesome Server" neutron1985/devops-example-app

multiarch-build-app:
	docker buildx build --platform linux/amd64,linux/arm64 -t neutron1985/devops-example-app .

multiarch-build-caddy:
	docker buildx build --platform linux/amd64,linux/arm64 -t neutron1985/devops-example-caddy -f services/caddy/Dockerfile .

multiarch-push-app:
	docker buildx build --platform linux/amd64,linux/arm64 -t neutron1985/devops-example-app --push .

multiarch-push-caddy:
	docker buildx build --platform linux/amd64,linux/arm64 -t neutron1985/devops-example-caddy -f services/caddy/Dockerfile --push .
